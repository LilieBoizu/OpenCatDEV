...
1, 0, 20,
  10,  6,  -45,  0,  0,  0,  0,  0,  31,  31, -58, -58,  27,  27,  42,  42,};



const char angry2[] PROGMEM = { 
1, 0, 0,
 10,  20,  0,  0,  0,  0,  0,  0,  60,  60, -60, -60,  -20,  -30,  20,  30,};

const char angry1[] PROGMEM = { 
1, 0, 0,
  10,  20,  0,  0,  0,  0,  0,  0,  60,  60, -60, -60,  -20,  -20,  20,  20,};

const char angry3[] PROGMEM = { 
1, 0, 0,
  10,  20,  0,  0,  0,  0,  0,  0,  60,  60, -60, -60,  -30,  -20,  30,  30,};




// Avancer les fesses en l'air
//const char angry2[] PROGMEM = { 
//1, 0, -10,
// 10,  20,  0,  0,  0,  0,  0,  0,  60,  60, -20, -20,  -30,  -20,  -30,  -40,};
//
//const char angry3[] PROGMEM = { 
//1, 0, -10,
//  10,  20,  0,  0,  0,  0,  0,  0,  60,  60, -20, -20,  -20,  -30,  -40,  -30,};
//
//const char angry1[] PROGMEM = { 
//1, 0, -10,
//  10,  20,  0,  0,  0,  0,  0,  0,  60,  60, -20, -20,  -20,  -20,  -40,  -40,};
  ...
  const char* skillNameWithType[]={"bdI","bkI","bkLI","bkRI","crI","crLI","crRI","lyI","trI","trLI","trRI","vtI","wkI","wkLI","wkRI","balanceI","buttUpI","calibI","cd1I","cd2I","droppedI","hiI","hi2I","liftedI","peeI","pee1I","pu1I","pu2I","rc1I","rc10I","rc2I","rc3I","rc4I","rc5I","rc6I","rc7I","rc8I","rc9I","restI","sitI","sleepI","strI","zeroN","angry1N","angry2N","angry3N",};
  const char* progmemPointer[] = {bd, bk, bkL, bkR, cr, crL, crR, ly, tr, trL, trR, vt, wk, wkL, wkR, balance, buttUp, calib, cd1, cd2, dropped, hi, hi2, lifted, pee, pee1, pu1, pu2, rc1, rc10, rc2, rc3, rc4, rc5, rc6, rc7, rc8, rc9, rest, sit, sleep, str, zero, angry1, angry2, angry3 };
  ...
  const char* progmemPointer[] = {zero, angry1, angry2, angry3};
#endif
